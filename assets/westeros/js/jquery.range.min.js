            ...
            if (!this.options.disable) {
                ...
                if (this.isSingle()) this.setPosition(this.pointers.last(), i, !0, !0);
                    ...
                    var s = Math.abs(parseFloat(this.pointers.first().css("left"), 10)),
                        ...
                        h = Math.abs(e - i + n),
                        l;
                    l = a == h ? s > i ? this.pointers.first() : this.pointers.last() : h > a ? this.pointers.first() : this.pointers.last(), this.setPosition(l, i, !0, !0), this.options.onbarclicked.call(this, this.options.value)
                }
            }
        },
